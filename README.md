...
ㄴ [🍋](https://github.com/mizykk/Work/blob/master/M/Find_words_in_sentences.ipynb) Find_words_in_sentences : 문장 속에서 단어 찾기   
ㄴ [🍉](https://github.com/mizykk/Work/blob/master/M/Getting_RGB_values_from_image.ipynb) Getting_RGB_values_from_image : 이미지에서 RGB 추출하기(화장품 색상)  
ㄴ [🍇](https://github.com/mizykk/Work/blob/master/M/Hit_path.ipynb) Hit_Path : GA hitsPath 정제     
ㄴ [🍓](https://github.com/mizykk/Work/blob/master/M/Movie_check.ipynb) Movie_check : 영화 개봉일이 2개월 이후인지 & 성인영화인지 판단  
ㄴ [🍒](https://github.com/mizykk/Work/blob/master/M/URL_Encoding.ipynb) URL_Encoding : URL 인코딩     
ㄴ [🍑](https://github.com/mizykk/Work/blob/master/M/Word_Cloud.ipynb) Word_Cloud : 워드클라우드   
